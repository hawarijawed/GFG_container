...
Note: Many orders may be possible for a particular test case, thus you may return any valid order and output will be 1 if the order of string returned by the function is correct else 0 
...
class Solution {
    public String findOrder(String[] dict, int n, int k) {
        ...
        for(Character ch:map.keySet()){
            if(!vis.contains(ch))    topologicalSort(map,st,vis,ch);
        }
